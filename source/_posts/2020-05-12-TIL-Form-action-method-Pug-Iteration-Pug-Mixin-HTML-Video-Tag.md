...
- [Iteration - Pug](https://pugjs.org/language/iteration.html)
...
- [Code - Pug](https://pugjs.org/language/code.html)
- [escape - 생활코딩](https://opentutorials.org/course/50/191)
...
- [Mixins - Pug](https://pugjs.org/language/mixins.html)
...
- [\<video\> - HTML \| MDN](https://developer.mozilla.org/ko/docs/Web/HTML/Element/Video)
